...
function ARTest(AspectRatio, wingspan, Vinf_in) #function assuming square wing
    c = wingspan / AspectRatio #solves for chord
...
function VLM(Sref, cref, bref, alpha, beta, omega, Vinf_in)
...
plot() #added this to reset the plots
